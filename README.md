...
+ [II. 사용 모델](https://github.com/jijeongwon/dacon#ii-%EC%82%AC%EC%9A%A9-%EB%AA%A8%EB%8D%B8)
...
이번 대회를 진행해봄으로써 UNet 기반 Generator와 PatchGAN Discriminator를 사용해 이미지 복원을 시도해 보았는데, 학습이 불안정할 때 GroupNorm을 적용해보면서 학습 안정성이 개선되는 걸 직접 눈으로 보고 코드를 수정하면서 여러 다양한 기법을 배울 수 있었던 것 같다. 특정 패턴을 복원하는 데에 있어서 어려움을 겪었지만, 다음 기회가 있다면 그땐 마스크를 직접 따서 그 부분을 집중적으로 복원할 수 있는 방법을 시도해보고 싶다.
